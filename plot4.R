...
global_reactive_power = as.numeric(df_sub$Global_reactive_power)
voltage = as.numeric(df_sub$Voltage)
...
# 2nd
plot(dt, voltage, type="l", xlab="date time", ylab="Voltage")
# 3rd
...
# 4th
plot(dt, global_reactive_power, type="l", xlab="date time", ylab="Global reactive power")
